...
export default function MyMessagesPage() {
  ...
  return (
    <section className="flex flex-col h-screen pb-12 text-white bg-gray-900">
      {/* Header repensé */}
        ...
        {conversations.length === 0 ? (
          ...
          conversations.map(({ id, sellerName, vehicleName, picture }) => (
            <li
              ...
              className="flex items-center p-4 transition bg-gray-800 shadow-md cursor-pointer rounded-xl hover:bg-gray-700"
            >
              <Image
                ...
                width={56}
                height={56}
                className="object-cover border-2 border-purple-500 rounded-full"
              />
              <div className="ml-4">
